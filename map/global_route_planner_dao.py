    ...
    def get_topology(self):
        ...
        topology into a list of dictionary objects.
            ...
            :return topology: list of dictionary objects with the following attributes
                ...
                path    -   list of waypoints at the sampling resolution 
                            from entry to exit
                length  -   length of segment at the given resolution
                            from entry to exit
        """
        topology = []
        ...
        for segment in self._wmap.get_topology():
            ...
            x1, y1, z1, x2, y2, z2 = np.round([l1.x, l1.y, l1.z, l2.x, l2.y, l2.z], 0).astype(np.int32)
